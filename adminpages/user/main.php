		...
		<div class="row">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <td><?php echo $data['email'];?></td>
								...
								<td><a href="<?php echo $admin_url; ?>user/form_edit.php?id_pelanggan=<?php echo $data['id'];?>">
								<button class="btn btn-warning">
									<i class="fa fa-edit"></i>
								</button></a>

								<a href="<?php echo $admin_url; ?>user/hapus.php?id_pelanggan=<?php echo $data['id'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
